#!/home/faneva/Bureau/T&R/tenv/bin/python
...
def load_admitted_students(file_path):
    ...
    if full_name_col:
        ...
        raise ValueError("Colonnes 'Nom' et 'Prénoms' ou 'Noms et Prénoms' introuvables dans le fichier.")
...
def process_files():
    try:
        ...
        if admitted_count > 0:
            ...
            tk.Label(
                result_frame,
                text=f"🎉 Félicitations aux {admitted_count}/{total_count} candidats inscrits au Cours Prépa T&R!",
                font=("Arial", 14)
            ).pack(pady=5)
...
def save_admitted_to_pdf():
    try:
        ...
        if save_path:
            ...
            title = Paragraph("LISTE PAR ORDRE DE MÉRITE DE NOS CANDIDATS ADMIS", title_style)
...
load_excel_button = tk.Button(
    ...
    bg="#4B7BEC", fg="white", font=("Courier New", 10, "bold"),
...
process_button = tk.Button(
    ...
    bg="#20BF6B", fg="white", font=("Courier New", 10, "bold"),
...
show_non_admitted_button = tk.Button(
    ...
    bg="#FF4C4C", fg="white", font=("Courier New", 10, "bold"),
...
student_file_label = tk.Label(frame, text="Aucun fichier Excel chargé.", font=("Courier New", 10))
student_file_label.pack()
student_file_label.bind("<Enter>", show_tooltip)
student_file_label.bind("<Leave>", hide_tooltip)

admitted_file_label = tk.Label(frame, text="Aucun fichier Admis chargé.", font=("Courier New", 10))
...
style = ttk.Style()
style.configure("Custom.Treeview", font=("Courier New", 12), rowheight=30,
                background="#F0F0F0", fieldbackground="#F0F0F0", foreground="#000000")
style.configure("Custom.Treeview.Heading", font=("Courier New", 13, "bold"), foreground="#000000")
...
admitted_table.heading("NumeroInscription", text="NUMÉRO D'INSCRIPTION")
